...
// https://github.com/abdolence/gcloud-sdk-rs/blob/master/examples/bigquery-storage-write-client/Cargo.toml

#[tokio::main]
pub async fn insert_data() -> Result<(), Box<dyn std::error::Error>> {
...
// Looks to require the creationg of a BigQuery job passing in parameters.
// https://cloud.google.com/bigquery/docs/batch-loading-data#c
