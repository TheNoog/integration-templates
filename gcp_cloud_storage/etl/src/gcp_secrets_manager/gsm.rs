...
// https://github.com/abdolence/gcloud-sdk-rs/blob/master/examples/secrets-manager-client/src/main.rs

#[tokio::main]
pub async fn get_gcp_secret() -> Result<(), Box<dyn std::error::Error>> {
    // Debug logging
    ...
    println!("Google Project ID = {}", google_project_id);
